...
router.route("/admin/user/update/:id").put(isAuthenticated, authorizeRoles("admin"), updateUserRole);

router.route("/admin/user/delete/:id").delete(isAuthenticated, authorizeRoles("admin"),deleteUser);
